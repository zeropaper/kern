...
function make(req, res){
  ...
  if (req.method.toLowerCase() == 'post') {
    ...
    form.addListener('fileBegin', function(name, file){K.log('log', 'fileBegin', arguments);});
    form.addListener('progress', function(bytesReceived, bytesExpected){K.log('log', 'progress', arguments);});
    form.addListener('file', function(name, file){K.log('log', 'progress', arguments);});
    
    form.parse(req, function(err, fields, files) {
      K.log('info', 'err', err, 'fields', fields, 'files', files);
