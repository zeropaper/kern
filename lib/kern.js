...
//        console.info('Triggering '+ ext.extensionName +':loaded');
  ...
  _.extend(Kern.prototype, {
    extendedBy: function(name) { return !_.isUndefined(this.extensions[name]); },
    getExtension: function(name) { return this.extensions[name]; },
    getTemplate: function(name) {
      console.info('Getting template '+ name, !onServer ? this.$('#'+ name +'-template').length : this.assets.templates[name +'-template']);
