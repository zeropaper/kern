...
//    K.__dirname = __dirname;
    ...
    if (!useContentEntries) console.groupEnd(); 
  };
  ...
  _.extend(Kern.prototype, {
    ...
    getTemplate: function(name) {
      ...
      tmpl = tmpl ? tmpl : '';
      if (!tmpl) {
        console.error('Template not found', name, tmpl);
...
//    Collections: {},
  ...
  // var CollectionView = Backbone.extend.View({
  //   collection: null,
  //   initialize: function(options) {
  //     var models = _.isArray(options.models) ? options.models : [];
  //     this.collection = options.collection || new Backbone.Collection(models, {
  //       view: this
  //     });
  //   }
  // });
  // Kern.Views.Collection = CollectionView;
