...
//        console.error(e);
  ...
  _.extend(Kern.prototype, {
    ...
    eval: function(content) {
      try {
        window.__kern__ = this;
        eval('(function(K){'+content+'})(window.__kern__);');
        delete window.__kern__;
      }
      catch (e) {
    ...
    render: function(templateName, variables) {
      ...
      this.log('debug', 'kern', 'Rendering '+ templateName, tmpl);
      try {
        ...
        return templateName +' error: '+ e.toString();
      }
    },
