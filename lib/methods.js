...
methods.assetFromURL = function(assetURL) {
  var K = this;
...
methods.assetFromFilepath = function(filepath) {
  var K = this;
...
methods.assetFilepathToURL = function(filepath) {
  var K = this;
...
methods.loadLayout = function(cb, layoutpath) {
  K = K || this;
  var $ = K.$;
...
methods.loadTemplates = function(templatespath) {
  var K = this;
  var $ = K.$;
