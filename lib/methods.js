...
methods.initialize = function() {
  ...
  K.assets.styles = {
    '/js/lib/jquery-ui/themes/base/jquery.ui.all.css': {
      filepath: K.publicDir() + '/js/lib/jquery-ui/themes/base/jquery.ui.all.css',
      weight: -50
    },
    '/js/lib/jquery-ui/themes/base/jquery.ui.theme.css': {
      filepath: K.publicDir() + '/js/lib/jquery-ui/themes/base/jquery.ui.theme.css',
      weight: -50
    },
    '/js/lib/jquery-ui/themes/base/jquery.ui.base.css': {
      filepath: K.publicDir() + '/js/lib/jquery-ui/themes/base/jquery.ui.base.css',
      weight: -50
    },
    /*
    'jquery.ui.notify': {
      href: '/js/lib/jquery-notify/ui.notify.css',
      filepath: K.publicDir() + '/js/lib/jquery-notify/ui.notify.css',
      weight: -50
    },
    */
    '/css/style.css': {
  ...
  K.assets.scripts = {
    '/js/lib/modernizr.min.js': {
      filepath: K.publicDir() + '/js/lib/modernizr.min.js',
      weight: -100
    },
    '/js/lib/respond.min.js': {
      filepath: K.publicDir() + '/js/lib/respond.min.js',
      weight: -99
    },
    '/js/lib/underscore.js': {
      filepath: K.publicDir() + '/js/lib/underscore.js',
      weight: -98
    },
    
    
    '/js/lib/jquery.min.js': {
      filepath: K.publicDir() + '/js/lib/jquery.min.js',
      weight: -97
    },
    
    
    '/js/lib/backbone.js': {
      filepath: K.publicDir() + '/js/lib/backbone.js',
      weight: -96
    },
    '/js/lib/backbone-localstorage.js': {
      filepath: K.publicDir() + '/js/lib/backbone-localstorage.js',
      weight: -95
    },
    
    '/js/lib/jquery-ui/ui/jquery.ui.core.js': {
      filepath: K.publicDir() + '/js/lib/jquery-ui/ui/jquery.ui.core.js',
      weight: -94
    },
    '/js/lib/jquery-ui/ui/jquery.ui.widget.js': {
      filepath: K.publicDir() + '/js/lib/jquery-ui/ui/jquery.ui.widget.js',
      weight: -93
    },
    '/js/lib/jquery-notify/src/jquery.notify.min.js': {
      filepath: K.publicDir() + '/js/lib/jquery-notify/src/jquery.notify.min.js',
      weight: -92
    },
...
methods.registerAssets = function() {
  K = K || this;
  console.info('Registering assets', K.assets);
  for (var t in _.clone(K.assets)) {
    var type = K.assets[t];
    console.info("Registering "+ t +" assets", type);
    for (var a in type) {
      (function(info){
        var asset = _.extend({type: t, path: typeof info.path == 'string' ? info.path : a}, info)
          , cb = typeof asset.callback == 'function' ? asset.callback : methods.sendAsset
        ;
        
        console.info("Registered "+ asset.path);
        K.app.get(asset.path, function(req, res, next) {
          console.info('Asset requested '+ req.url, t, a, asset);
...
//    content = require('./fs/js').compressJS(content);
  ...
  console.info('K.app.routes.routes.get', K.app.routes.routes.get);
  */
