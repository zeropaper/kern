(function(wexpows) {
  ...
  kern.apply = function(file) {
    ...
    data.url = data.id;
    for (var selector in kern.rules) {
      // console.info('Applying rule '+ selector);
      try {
        kern.rules[selector].call($(selector), data, true, K);
      } catch (e) {
  ...
  kern.analyse = function(str, options) {
    ...
    for ( var selector in kern.rules) {
      ...
      kern.rules[selector].call($(selector, $f), parsed, false, K);
    }
    return parsed;
  };
  ...
  kern.rules = {};
/*
  kern.rules['[role="site-name"]'] = function(analysed, place, K) {
    if (place && this.length) {
      this.text(K.settings.appName);
    }
  };

  kern.rules['[src]:not(base),[href]:not(base)'] = function(analysed, place) {
  ...
  kern.rules['video'] = function(analysed, place) {
  ...
  kern.rules['[role=static-dev-scripts]'] = function(analysed, place) {
    this.remove();
  };

  kern.rules['[role=document-title], .page-title, title'] = function(
      analysed, place) {
    if (!place) {
  ...
  kern.rules['[role=document-body], body'] = function(analysed, place) {
  ...
  kern.rules['[role=document-aside]'] = function(analysed, place) {
    analysed.regions = analysed.regions || {};
    if (!place) {
  ...
  kern.rules['meta[property^="og:"]'] = function(analysed, place) {
  ...
  kern.rules['.kern-template'] = function(analysed, place) {
    if (!onServer)
      return;
  ...
  kern.rules['.kern-script'] = function(analysed, place) {
    if (!onServer)
      return;
  ...
  kern.rules['.kern-style'] = function(analysed, place) {
    if (!onServer)
      return;
  ...
  kern.rules['[type="kern/lib"]'] = function(analysed, place) {
    if (this.length)
  ...
  kern.rules['#meta'] = function(analysed, place) {
    if (!place)
      return;
    var info = [];
  ...
  kern.rules['.kern-remove'] = function(analysed) {
    this.remove();
  };
*/
