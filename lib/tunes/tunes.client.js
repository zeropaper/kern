    ...
    var $audio       = $(settings.playerHolder + ' audio')
      ...
      , PlaylistView  = Backbone.View.extend({
        ...
        , setSrc: function(ev) {
            ...
            console.info('Title setSerc '+ src);
      ...
      , PlayerView = Backbone.View.extend({
          ...
          render: function() {
            ...
            if (!this.player && this.currentTrack) {
              ...
              console.info("Setting src "+ '/av/same'+ track.id/*get('url')*/);
              ...
              console.info('Player is paused?', player, player.media.paused, $('.play', view.el).length);
              ...
              function dispatcher(ev) {
                ...
                switch (ev.type) {
                  case 'ended':
                    view._pause();
                    var next = view.collection.next();
                    console.info('Track ended, next', next);
                    this.setSrc(next.id/*get('url')*/);
                    break;
                  case 'pause':
                    console.info('Track paused');
                    view._pause();
                    break;
                  case 'play':
                  case 'playing':
          ...
          setSrc: function(src) {
            console.info('playerView.setSrc("'+ src +'")');
            var src = '/av/same'+ (src);
            try {
              console.info('Setting src '+ src);
              this.player.setSrc(src);
            }
            catch (e) {
              console.error('setSrc error', src, e);
